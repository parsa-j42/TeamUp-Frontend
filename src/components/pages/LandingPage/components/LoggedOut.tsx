import {Box, Stack, Title, Text, useMantineTheme, Image, Group, Flex, Divider} from '@mantine/core';
    ...
    return (
        <Stack gap={0}>
            ...
            <Box pt="50px" pb="150px">
                        ...
                        <Image src="/placeholderImageHorizontal.svg" h={450} w="auto"/>
                        </Group>
                    </Box>
                ...
                >
                    <Flex direction="row" h="650px">
                        ...
                        >
                            ...
                            <Box ml="10%">
                            <RoundedButton w="50%" color="mainRed.6" variant="filled" fw="500">Sign Up</RoundedButton>
                                <Text c="mainRed.6" fw="700" ml="1%" size="xs" mt="md" style={{ textAlign: 'left' }}>
                                    By clicking Sign Up you<span style={{fontFamily: 'calibri'}}>'</span>re confirming that you agree with our&nbsp;
                                    <Text c="black" component="a" href="/terms" size="xs" td="underline">Terms and Conditions</Text>
                                </Text>
